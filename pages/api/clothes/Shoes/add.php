...
add($available_colors, "shoes", $_POST['shoes_color'], $_FILES['shoes_file']['name'], $_FILES['shoes_file']['tmp_name'], $_FILES['shoes_file']['size'], $_FILES['shoes_file']['error'], $_FILES['shoes_file']['type'], $login_db, $user_id);
