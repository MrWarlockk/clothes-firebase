...
add($available_colors, "pants", $_POST['pants_color'],  $_FILES['pants_file']['name'], $_FILES['pants_file']['tmp_name'], $_FILES['pants_file']['size'], $_FILES['pants_file']['error'], $_FILES['pants_file']['type'], $login_db, $user_id);
