...
add($available_colors, "shirt", $_POST['shirt_color'], $_FILES['shirt_file']['name'], $_FILES['shirt_file']['tmp_name'], $_FILES['shirt_file']['size'], $_FILES['shirt_file']['error'], $_FILES['shirt_file']['type'], $login_db, $user_id);
